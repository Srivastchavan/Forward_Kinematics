...
void Renderer::nanogui_init(GLFWwindow* window)
{
	...
	******************************************************************************/
	...
	gui_1->addGroup("Bone Position");

	static auto bone1_x_widget = gui_1->addVariable("Rotate Yellow x1", m_bone_animation->rotation_degree_vector[1][2]);
	static auto bone1_y_widget = gui_1->addVariable("Rotate Yellow y1", m_bone_animation->rotation_degree_vector[1][0]);
	static auto bone1_z_widget = gui_1->addVariable("Rotate Yellow z1", m_bone_animation->rotation_degree_vector[1][1]);

	static auto bone2_x_widget = gui_1->addVariable("Rotate Pink x2", m_bone_animation->rotation_degree_vector[2][2]);
	static auto bone2_y_widget = gui_1->addVariable("Rotate Pink y2", m_bone_animation->rotation_degree_vector[2][0]);
	static auto bone2_z_widget = gui_1->addVariable("Rotate Pink z2", m_bone_animation->rotation_degree_vector[2][1]);

	static auto bone3_x_widget = gui_1->addVariable("Rotate Turquoise x3", m_bone_animation->rotation_degree_vector[3][2]);
	static auto bone3_y_widget = gui_1->addVariable("Rotate Turquoise y3", m_bone_animation->rotation_degree_vector[3][0]);
	static auto bone3_z_widget = gui_1->addVariable("Rotate Turquoise z3", m_bone_animation->rotation_degree_vector[3][1]);


	gui_1->addButton("Reset Bone Rotation", []() {
		m_bone_animation->reset();
		bone1_x_widget->setValue(m_bone_animation->rotation_degree_vector[1][2]);
		bone1_y_widget->setValue(m_bone_animation->rotation_degree_vector[1][0]);
		bone1_z_widget->setValue(m_bone_animation->rotation_degree_vector[1][1]);

		bone2_x_widget->setValue(m_bone_animation->rotation_degree_vector[2][2]);
		bone2_y_widget->setValue(m_bone_animation->rotation_degree_vector[2][0]);
		bone2_z_widget->setValue(m_bone_animation->rotation_degree_vector[2][1]);

		bone3_x_widget->setValue(m_bone_animation->rotation_degree_vector[3][2]);
		bone3_y_widget->setValue(m_bone_animation->rotation_degree_vector[3][0]);
		bone3_z_widget->setValue(m_bone_animation->rotation_degree_vector[3][1]);
...
void Renderer::draw_bones(Shader& shader, Bone_Animation* m_bone_animation)
{
	...
	{
		root_bone_obj_mat[i] = glm::scale(m_bone_animation->bone_mat[i], m_bone_animation->scale_vector[i]);
